package com.bingor.picker.datetimepickerdialog.wheel;
...
import com.bingor.picker.datetimepickerdialog.util.ConvertUtils;
...
public class WheelView extends View {
    ...
    private static final float SCALE_CONTENT = 1F;//非中间文字用此控制高度，压扁形成3D错觉
     ...
     * 设置滚轮个数偏移量
     */
    private final void setOffset(@IntRange(from = 1, to = 5) int offset) {
        ...
        postDelayed(new Runnable() {
            ...
            public void run() {
                if (onItemSelectListener != null) {
                    onItemSelectListener.onSelected(WheelView.this, selectedIndex);
                }
